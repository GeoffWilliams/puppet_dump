...
all:
	cd .pdqtest && bundle exec pdqtest --skip-idempotency all

fast:
	cd .pdqtest && bundle exec pdqtest --skip-idempotency fast

acceptance:
	cd .pdqtest && bundle exec pdqtest --skip-idempotency acceptance

shell:
	cd .pdqtest && bundle exec pdqtest --skip-idempotency --keep-container acceptance
